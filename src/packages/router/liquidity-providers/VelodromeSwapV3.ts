...
export class VelodromeSwapV3Provider extends VelodrmoeV3BaseProvider {
  constructor(chainId: ChainId, web3Client: PublicClient) {
    ...
    const tickLens = {
      ...
      [ChainId.LISK]: "0xaB19a265EDe95c66c9A1159176088f0c9E2B48F7",
